...
session_start();
//Membuat sebuah kondisi untuk melakukan cek apakah yang mengakses halaman ini sudah login atau belum
if ($_SESSION['role'] = "") {
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="#"><i class="fa fa-circle-o"></i>Tambah Transaksik</a></li>
          </ul>
        </li>
        <li>
          <a href="#">
